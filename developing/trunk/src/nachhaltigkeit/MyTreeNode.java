...
{
	private static final Font SMALL_FONT = new Font( "Dialog",
	                                                 Font.BOLD,
	                                                 10 );
	...
	protected JTextField machÜberschrift()
	{
		...
		überschrift.setText( "Dieses Diagramm stellt " + bezeichnung
		                     + " dar." );
	...
	/**
	 * Diese Methode wird von allen Elementen im jTree implementiert.
	 * Wenn ein Element angeklickt wird dann wird durch dessen
	 * Implementierung ein entsprechendes Diagramm gezeichnet und als
	 * JPanel zurückgegeben.
	 * 
	 * @author andre
	 */
