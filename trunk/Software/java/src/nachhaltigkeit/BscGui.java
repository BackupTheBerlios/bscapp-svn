...
public class BscGui extends JFrame implements TreeSelectionListener
{
	...
	private JTree getJTree()
	{
		if( jTree == null )
		{
			...
			/*
			 * TODO: konstruktor von bereich modifizieren, dass er
			 * eine wichtigkeit erwartet
			 */
	...
	private void initialize()
	{
		...
		this.setLocation( mitteDesBildschirms() );
	...
	public void valueChanged( TreeSelectionEvent e )
	{
		...
		// This method is useful only when the selection model allows
		// a single
		// selection.
	...
	private Point mitteDesBildschirms()
	{
		...
		int wW = super.getSize().width;
		int wH = super.getSize().height;
		
		return new Point( sW / 2 - wW / 2, sH / 2 - wH / 2 );
	}
	...
	private JMenuBar getJMenuBar2()
	{
		...
		JMenuItem benutzerbearbeiten = new JMenuItem( "Benutzer bearbeiten" );
		
		bar.add( admin );
		admin.add( benutzerbearbeiten );
