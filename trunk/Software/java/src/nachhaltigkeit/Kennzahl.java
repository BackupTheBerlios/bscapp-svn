...
public class Kennzahl extends MyTreeNode
{
	...
	public JPanel gibDiagramm()
	{
		...
		pieDataset.setValue("sehr zufrieden", new Integer(18)) ;
		pieDataset.setValue("zufrieden", new Integer(30)) ;
		pieDataset.setValue("wenig zufrieden", new Integer(54)) ;
		pieDataset.setValue("Stimmenthaltungen", new Integer(10)) ;
